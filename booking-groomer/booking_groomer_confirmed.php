...
<head>
    ...
    <title>Bookings - Updated Bookings</title>
    ...
    <div class="container mb-5 mt-5">
                    ...
                    <div class="col-lg-12">
                        <div class="change-booking-outer d-flex flex-column align-items-center">
                            ...
                            <div class="d-flex align-items-center gap-10 mt-5">
                                <h1 class="large-font d-flex">Your grooming appointment is </h1>
                                <h1 class="large-font-bold">confirmed!</h1>
                            </div>
                            <p class="medium-light-font font-color">Your grooming appointment with Sarah has been successfully booked. </p>
                            <p class="medium-light-font font-color">They’ll be providing the service [at your home/as a mobile visit] at the time below. </p>


                            <div class="content-wrap">
                                <div class="booking-cards mt-5">
                                    <div class="booking-card-top d-flex align-items-center justify-content-between">
                                ...
                                <div class="booking-cards no-border mt-5">
        ...
        <div class="row">
            <div class="col-lg-12 mt-5">
                <div class="space-section d-flex flex-column align-items-center justify-content-center mt-5">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="76" height="52" viewBox="0 0 76 52" fill="none">
                            <rect x="11.8813" y="1.00977" width="50.0001" height="17.8218" rx="8.91091" fill="#FFA899" />
                            <rect y="18.3379" width="50.0001" height="17.3268" rx="8.66339" fill="#FFA899" />
                            <rect x="25.2478" y="33.1875" width="50.0001" height="17.8218" rx="8.91091" fill="#FFA899" />
                            ...
                            <path d="M13.1436 33.0391C15.4812 33.0391 17.3763 30.5124 17.3763 27.3955C17.3763 24.2787 15.4812 21.752 13.1436 21.752C10.8059 21.752 8.91089 24.2787 8.91089 27.3955C8.91089 30.5124 10.8059 33.0391 13.1436 33.0391Z" stroke="#3B3731" stroke-width="4" />
                            <path d="M13.1436 33.0391V49.9698" stroke="#3B3731" stroke-width="4" stroke-linecap="round" />
                            <path d="M8.91089 49.9709H65.3467M37.1288 49.9709V38.6837C37.1288 36.0227 37.1288 34.6937 37.9556 33.8669C38.7824 33.0401 40.1114 33.0401 42.7724 33.0401H45.5942C48.2551 33.0401 49.5842 33.0401 50.4109 33.8669C51.2377 34.6937 51.2377 36.0227 51.2377 38.6837V49.9709M41.3615 24.5747H47.005M41.3615 16.1094H47.005" stroke="#3B3731" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>

...
(e.g. anxious around dryers, allergies, behaviour cues)" rows="4" cols="50" id="petNotes"></textarea>
                            ...
                            <div class=" address-service">
                                ...
                                <div class="option" id="home-address-option"
                                    style="margin: 2rem 0; width: fit-content; display: flex !important; flex-direction: row !important; align-items: center !important;"
                                    ...
                                    <div class="form-grid">
                                        ...
                                        <div class="full-row">
                                            ...
                                            <div class="input-wrap select-wrap" data-field="country">
                                                <select data-furs-dropdown id="country" name="country">
                                ...
                                <div class="payment-icons">
                                    ...
                                    <div>
                                        ...
                                        <div class="pay-btn" style="background:#FFD88C;">
                                            <image src="<?= BASE_URL ?>/assets/images/icons/paypal-icon.png"
                                                alt="Pet Photo Placeholder" />

                                        </div>
                                        <div class="pay-btn">
                                            <image src="<?= BASE_URL ?>/assets/images/icons/g-pay-icon.png"
                                                alt="Pet Photo Placeholder" />
                                ...
                                <div class="card-payment-section">
                                    <div class="card-payment-header">
                                        <div style="display:flex;align-items:center;gap:10px;">
                                            ...
                                            <span
                                                style="font-family:Lato;font-size:16px;font-weight:500;color:#3B3731;">Credit/Debit
                                                Card</span>
                                        </div>
                                    </div>
                                    <div class="card-payment-body">
                                        <div class="card-form-grid">
                                            <div class="card-form-group full-row">
                                                ...
                                                <div class="input-wrap valid">
                                                    <input type="text" id="cardNumber" placeholder="0000 0000 0000 0000"
                                                        maxlength="19" value="0000 0000 0000 0000"
                                                        style="width:100%;box-sizing:border-box;padding:12px 44px 12px 14px;border-radius:10px;border:1px solid #D4D4D4;font-family:Lato;font-size:16px;height:48px;outline:none;" />
                                                    <span class="icon" style="opacity:1;"><svg
                                            ...
                                            <div class="card-form-group full-row">
                                                ...
                                                <div class="input-wrap valid">
                                                    <input type="text" id="nameOnCard" placeholder="Lorem, Ipsum"
                                                        value="Lorem, Ipsum"
                                                        style="width:100%;box-sizing:border-box;padding:12px 44px 12px 14px;border-radius:10px;border:1px solid #D4D4D4;font-family:Lato;font-size:16px;height:48px;outline:none;" />
                                                    <span class="icon" style="opacity:1;"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="19" height="19"
                                            ...
                                            <div class="card-form-group">
                                                ...
                                                <div style="display:flex;gap:10px;">
                                                    <select data-furs-dropdown
                                                        style="flex:1;height:48px;border-radius:10px;border:1px solid #D4D4D4;padding:0 12px;font-family:Lato;font-size:16px;color:#3B3731;background:#fff;-webkit-appearance:none;appearance:none;background-image:url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2212%22 height=%228%22 viewBox=%220 0 12 8%22><path d=%22M1 1l5 5 5-5%22 stroke=%22%233B3731%22 stroke-width=%221.5%22 fill=%22none%22 stroke-linecap=%22round%22/></svg>');background-repeat:no-repeat;background-position:right 12px center;background-size:12px;">
                                            ...
                                            <div class="card-form-group">
                                                ...
                                                <div style="position:relative;">
                                                    <input type="text" placeholder="000" maxlength="4"
                                                        style="width: 175px;box-sizing:border-box;padding:12px 44px 12px 14px;border-radius:10px;border:1px solid #D4D4D4;font-family:Lato;font-size:16px;height:48px;outline:none;" />
                                                    <span
                                                        style="position:absolute;right:13.5rem;top:50%;transform:translateY(-50%);cursor:pointer;"
                                                        title="3-4 digit security code">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                            viewBox="0 0 24 24" fill="none" stroke="#9D9B98"
                                        ...
                                        <div class="card-checkbox-row"
                                            onclick="toggleCardCheck('billingCheck','billingInner')">
                                            <div id="billingCheck"
...
line-height: normal;
                                        ...
                                        <hr style="border: 1px solid #CBDCE8;">
                                        <!-- Terms checkbox -->
                                        <div class="card-checkbox-row"
                                            onclick="toggleCardCheck('termsCheck','termsInner')">
                                            <div id="termsCheck"
                                                style="width:22px;height:22px;border-radius:50%;border:2px solid #FFD88C;display:flex;align-items:center;justify-content:center;flex-shrink:0;background:#fff;">
                                                <span id="termsInner"
                                                    style="width:12px;height:12px;border-radius:50%;background:#FFD88C;display:block;"></span>
...
font-style: normal;
font-weight: 400;
line-height: normal;">I agree to
                                                Fursgo's <a href="#">Terms of
                                                    Service</a> and <a href="#">Cancellation
                                                    Policy</a>.</span>
                                        </div>
                                ...
                                <!-- Security note -->
                                <p
                                    style="display:flex;align-items:center;gap:6px;color:#9D9B98;font-family:Lato;font-size:13px;margin-top:4px;padding-top:10px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="12" height="13" viewBox="0 0 12 13"
                                        fill="none">
                                        <path
                                            d="M6 0.5L1 2.5V6.5C1 9.26 3.24 11.84 6 12.5C8.76 11.84 11 9.26 11 6.5V2.5L6 0.5Z"
                                            stroke="#9D9B98" stroke-width="1" fill="none" />
                                        <path d="M4 6.5L5.5 8L8 5" stroke="#9D9B98" stroke-width="1"
                                ...
                                <div style="margin-top:2rem;max-width:820px;">
                                    <h2
                                        style="color:#3B3731;font-family:'Playfair Display';font-size:24px;font-weight:800;margin-bottom:1rem;">
                                        Remember me</h2>
...
font-style: normal;
font-weight: 400;
line-height: normal;">Save my information
                                            for a faster checkout</span>
                                    </div>
                                </div>

                                <!-- Accordion Policies -->
                                <div style="margin-top:2rem;max-width:820px;border-top:1px solid #EBEBEB;">
                                    <!-- Cancellation Policy (open by default) -->
                                    <div style="border-bottom:1px solid #EBEBEB;">
                                        <div onclick="togglePolicy(this)" style="display:flex;justify-content:space-between;align-items:center;padding:18px 0;cursor:pointer;color: #3B3731;
font-family: Lato;
font-size: 20px;
font-style: normal;
font-weight: 600;
line-height: normal;">
                                            ...
                                            <svg id="chevron-cancellation" xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="10" viewBox="0 0 16 10" fill="none"
                                                style="transition:transform 0.2s;transform:rotate(180deg);">
                                                <path d="M14.5 8.5L8 2L1.5 8.5" stroke="#3B3731" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </div>
                                        <div style="padding-bottom:16px;">
                                            <ul style="margin:0;padding-left:20px;list-style-type:disc;">
                                                <li style="color: #9D9B98;
font-family: Lato;
font-size: 18px;
font-style: normal;
font-weight: 400;
line-height: normal;
line-height: 1.5;">
                                                    Groomers are trained and certified professionals.</li>
                                                <li style="color: #9D9B98;
font-family: Lato;
font-size: 18px;
font-style: normal;
...
line-height: normal;
line-height: 1.5;">
                                                    Appointments are based on the service and duration you booked.</li>
                                                <li style="color: #9D9B98;
font-family: Lato;
font-size: 18px;
font-style: normal;
...
line-height: normal;
line-height: 1.5;">
                                                    Groomers may refuse service if your pet poses a safety risk.</li>
                                                <li style="color: #9D9B98;
font-family: Lato;
font-size: 18px;
font-style: normal;
...
line-height: normal;
line-height: 1.5;">
                                                    Please ensure your pet is up-to-date with vaccinations.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!-- Safety Policy -->
                                    <div style="border-bottom:1px solid #EBEBEB;">
                                        <div onclick="togglePolicy(this)"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="10"
                                                viewBox="0 0 16 10" fill="none" style="transition:transform 0.2s;">
                                                <path d="M14.5 1.5L8 8L1.5 1.5" stroke="#3B3731" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </div>
...
line-height: normal;
line-height: 1.5;">
                                                    All grooming tools are sanitised after every pet.</li>
                                                <li style="color: #9D9B98;
font-family: Lato;
font-size: 18px;
font-style: normal;
...
line-height: normal;
line-height: 1.5;">
                                                    Groomers follow industry-standard hygiene protocols.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!-- Payment & Fees -->
...
line-height: normal;
line-height: 1.5;">
                                                    Payment is processed securely at time of booking.</li>
                                                <li style="color: #9D9B98;
font-family: Lato;
font-size: 18px;
font-style: normal;
...
line-height: normal;
line-height: 1.5;">
                                                    A platform fee is included in the total price shown.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="service-summary">
                            ...
                            <div>
                                <div>
                                    ...
                                    <image src="<?= BASE_URL ?>/assets/images/service-summary-image.png"
                                        alt="Pet Photo Placeholder" />
                                </div>
                                <div>
                                    <div>
    ...
    <script>
        ...
        (function () {
            ...
            document.querySelectorAll('.form-group').forEach(group => {
                ...
                if (!input) return;
                // avoid adding twice
                if (!group.querySelector('.picker-opener')) {
                    // create button
                    const btn = document.createElement('button');
                    btn.type = 'button';
                    btn.className = 'picker-opener';
                    btn.setAttribute('aria-label', 'Open date picker');
                    btn.innerHTML = '<span style="position:absolute;left:-9999px">Open date picker</span>';
                    // click behaviour: showPicker() if supported, otherwise focus()
                ...
                // helper to open picker with fallback
                const openPicker = () => {
                    if (typeof input.showPicker === 'function') {
                        try {
                            input.showPicker();
                    ...
                    // Fallback: focus the input. On some mobile UA this opens the picker.
                    input.focus();
                    // Extra fallback attempt (desktop): try to simulate a mousedown which some UAs honor.
                    try {
                        ...
                        // ignore if synthetic events are blocked
                    }
                };
                // If user clicks anywhere inside the form-group (not on other controls) open the picker.
                group.addEventListener('click', (e) => {
                    // don't intercept clicks on other interactive elements (like <button> inside group) — but allow when clicking label or empty area
                    const interactive = e.target.closest('button, a, input:not([type="date"]), select, textarea, label[for]');
                    if (interactive && !e.target.matches('input[type="date"]')) {
                        // allow normal behavior for other controls
                        return;
                    }
                    openPicker();
                });
                // Also open on a click directly on the input itself (ensures consistent behavior)
                input.addEventListener('click', (e) => {
                    e.stopPropagation();
                    openPicker();
                });
                // Optional: open on keyboard Enter/Space when input or label has focus
      ...
      `;
        ...
        function checkContinueBtnState() {
            ...
            const petNameFilled = (petNameInput && petNameInput.value.trim() !== '') ||
                (parsedSaved && parsedSaved.name && parsedSaved.name.trim() !== '');

            const petBirthdayFilled = (() => {
                const liveInput = document.querySelector('input[name="birthday"]');
                return (liveInput && liveInput.value.trim() !== '') ||
                    (parsedSaved && parsedSaved.birthday && parsedSaved.birthday.trim() !== '');
            })();

            const petTypeFilled = (petTypeInput && petTypeInput.value.trim() !== '') ||
                (parsedSaved && parsedSaved.type && parsedSaved.type.trim() !== '');

            const petBreedFilled = (petBreedSelect && petBreedSelect.value.trim() !== '' && petBreedSelect.value !== 'Select a Breed') ||
                (parsedSaved && parsedSaved.breed && parsedSaved.breed.trim() !== '');

            const petSexFilled = (petSexInput !== null) ||
                (parsedSaved && parsedSaved.sex && parsedSaved.sex.trim() !== '');

            const petWeightFilled = (petWeightInput && petWeightInput.value.trim() !== '') ||
                (parsedSaved && parsedSaved.weight && parsedSaved.weight.toString().trim() !== '');
            ...
            if (allFilled) {
                ...
                continueBtn.querySelector('svg path').setAttribute('fill', '#FFF');
            } else {
                continueBtn.classList.remove('active');
                continueBtn.querySelector('button').style.color = '#DDD';
                continueBtn.querySelector('svg path').setAttribute('fill', '#DDDDDD');
            }
        }
    ...
    `;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            continueBtn.addEventListener('click', function () {
                ...
                // Populate confirm page with live data
                const savedPetDetails = sessionStorage.getItem('petDetails');
                if (savedPetDetails) {
                    const pet = JSON.parse(savedPetDetails);
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Watch all required live inputs
            [petNameInput, petTypeInput, petWeightInput, addressInput, birthdayInput].forEach(input => {
                if (input) input.addEventListener('input', checkContinueBtnState);
            });

            // Breed is a select
            if (petBreedSelect) petBreedSelect.addEventListener('change', checkContinueBtnState);

            // Sex radios
            document.querySelectorAll('input[name="sex"]').forEach(radio => {
                radio.addEventListener('change', checkContinueBtnState);
            });
            ...
            // Initial check after page restore
            setTimeout(checkContinueBtnState, 50);
        });
        ...
        const _petNameInput = document.getElementById('petName');
        ...
        // Also restore on page load if sessionStorage has values
        const savedPet = sessionStorage.getItem('petDetails');
        if (savedPet) {
            try {
        ...
        // Set up field rules and listeners
        (function () {
            ...
            const rules = {
                ...
                phone: v => /^\+?[\d\s\-\(\)]{7,20}$/.test(v), // basic international-ish phone match
            ...
            function setValid(name, state) {
                ...
                wrap.classList.toggle('error', !state && name === 'phone'); // only show error UI for phone as per screenshot
                // for phone show/hide x icon
                if (name === 'phone') {
            ...
            function validateOne(name) {
                ...
                setValid(name, ok);
                // show phone error message element
                if (name === 'phone') {
                    const err = document.getElementById('phoneError');
                    if (!ok) err.style.display = 'block'; else err.style.display = 'none';
                }
                return ok;
            }
            ...
            // initial quick check for prefilled demo content (if any)
            document.addEventListener('DOMContentLoaded', () => {
                Object.keys(rules).forEach(name => validateOne(name));
            });

        })();

        function toggleCardCheck(boxId, innerId) {
        ...
        const _cn = document.getElementById('cardNumber');
        if (_cn) _cn.addEventListener('input', function () {

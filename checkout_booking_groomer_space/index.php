...
$groomerImage = BASE_URL . 'assets/images/card1.png';
...
<head>
    ...
    <title>FursGo - Book a Groomer &amp; Space</title>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>checkout_booking_groomer_space/checkout_booking_groomer_space.css">
</head>
...
<body class="cbg-page" data-base-url="<?= BASE_URL ?>">
    ...
    <script src="<?= BASE_URL ?>checkout_booking_groomer_space/checkout_booking_groomer_space.js"></script>
</body>

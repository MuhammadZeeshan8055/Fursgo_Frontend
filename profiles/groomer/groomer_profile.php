...
<head>
    ...
    <style>
        ...
        #map .leaflet-tile,
        #space-map .leaflet-tile {
            filter: grayscale(100%) brightness(1.08) contrast(0.85) saturate(0%);
        }
                ...
                <div class="service-card mt-4 mb-5">
                    ...
                    <div class="service__availability mt-5">
                        ...
                        <div class="service-type-select mt-4">
                            ...
                            <div class="custom-select" data-multiselect>
                            ...
                            <div class="service-selected-options d-flex align-items-center flex-wrap gap-10 mt-4">
                                <div class="selected-item d-flex align-items-center gap-10" style="background: none;color: #FBAC83; border:1px solid #FBAC83">
                                    <p>Full groom</p>
                        ...
                        <div class="service-type-select mt-4">
                            ...
                            <div class="service-selected-options d-flex align-items-center flex-wrap gap-10 mt-4">
                                <div class="selected-item d-flex align-items-center gap-10" style="background: none;color: #FFC97A;border:1px solid #FFC97A">

                    ...
                    <div class="modal-card-right-section d-flex align-items-center gap-45">
                        ...
                        <div class="name-reviews d-flex flex-column gap-10">
                            <div>
                                ...
                                <p class="dark-color-font ">Hosted by<span class="muted-color"> Dev É.</span></p>
                            </div>
                                    ...
                                    <ul>
                                        <li>
                                            <label>
                                                ...
                                                <input type="checkbox" name="groomer-venue[]" value="Salons">
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <input type="checkbox" name="groomer-venue[]" value="Mobile Station" checked="">
                                                <span class="check-circle"></span>
                                            </label>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>
                                            <label>
                                                ...
                                                <input type="radio" name="groomer-sort" value="default" checked=""> <span class="check-circle"></span>
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                        ...
                        <div class="service-type-select booking-step mt-4">
                            ...
                            <div class="custom-select" data-multiselect data-pill="accent" data-summary="service" data-placeholder="Select service type">
                                ...
                                <ul class="select-options">
                                    <li data-value="hourly" data-label="Hourly" data-price="£25" data-amount="25">
                                        <span class="option-label">Hourly</span>
                                        <span class="option-price">£25</span>
                                    </li>
                                    <li data-value="half-day" data-label="Half-Day (4 hours)" data-price="£25" data-amount="25">
                                        <span class="option-label">Half-Day (4 hours)</span>
                                        <span class="option-price">£25</span>
                                    </li>
                                    <li data-value="full-day" data-label="Full-Day (8 hours)" data-price="£25" data-amount="25">

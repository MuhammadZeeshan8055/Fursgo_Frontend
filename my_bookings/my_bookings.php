...
<body class="status-cancel">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="bookings-header mt-4">
                            <div class="bookings-title">
                                <h1 class="large-font" id="bookings-title">All Bookings</h1>
                            </div>
    ...
    <script>
        ...
        const bookingsTitle = document.querySelector('#bookings-title');
        ...
        function hideAll() {
            ...
            sectionTitle.forEach(el => el.style.display = 'none');
            sectionDivider.forEach(el => el.style.display = 'none');
        }
        ...
        function show(type) {
            ...
            bookingsTitle.innerText = titles[type];

            if (type === 'all') {
                upcomingSection.style.display = 'block';
                pastBookings.forEach(el => el.style.display = 'block');
                cancelledBookings.forEach(el => el.style.display = 'block');
                sectionTitle.forEach(el => el.style.display = 'block');
                sectionDivider.forEach(el => el.style.display = 'block');
            }

            if (type === 'upcoming') upcomingSection.style.display = 'block';

            if (type === 'past') pastBookings.forEach(el => el.style.display = 'block');

            if (type === 'cancelled') cancelledBookings.forEach(el => el.style.display = 'block');
        }
        ...
        tabs.forEach(tab => {
            tab.addEventListener('click', function() {
                ...
                show(this.innerText.trim().toLowerCase());
            });
        });
    </script>
    <script>

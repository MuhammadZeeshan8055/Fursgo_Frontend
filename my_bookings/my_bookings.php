                            ...
                            <div class="mb-section">
                                ...
                                <article class="mb-card mb-card--completed">
                                    ...
                                    <div class="mb-card__footer">
                                        ...
                                        <button type="button" class="mb-btn mb-btn--orange" data-modal-open="review-modal"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                                <path d="M7 1.2L8.6 4.7L12.5 5.1L9.6 7.7L10.5 11.5L7 9.5L3.5 11.5L4.4 7.7L1.5 5.1L5.4 4.7L7 1.2Z" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round" />

...
<head>
    ...
    <style>
        ...
        .change-groomer-cb-pet-thumbnail {
            width: 48px;
            height: 48px;
            border-radius: 50%;
        }
        ...
        .date.selected {
            border-radius: 10px;
            border: 1px solid #91a36c;
            background: #d8e8b7;
            box-shadow: 0 5px 8px 0 rgba(0, 0, 0, 0.2);
        }

        /* Availability */
        .cb-availability-title {
            display: flex;
            align-items: center;
            gap: 8px;
            margin: 20px 0 10px;
        ...
        /* Refund Alert Styling */
        .cb-refund-alert {
            background-color: rgba(201, 221, 160, 0.2);
            color: #bcd093;
            padding: 12px 20px;
            border-radius: 10px;
            font-size: 14px;

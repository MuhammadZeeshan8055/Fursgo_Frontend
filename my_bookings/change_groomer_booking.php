                                            <p class="cb-label"> Date</p>
                                        </div>
                                ...
                                <div class="cb-selection-container">
                                    ...
                                    <div class="calendar mt-4">
                                        <div class="calendar-header">
                                            ...
                                            <span id="cal-title">October 2025</span>
                        ...
                        <section class="cb-container" id="extras-section">
                            ...
                            <!-- Editor -->
                            <div class="cb-extras-addons cb-panel-editor" id="extras-editor">
                        ...
                        <div class="section-divider" style="border-top: 1px solid #EAE8E5;"></div>

                        <section class="cb-summary-section cb-container mt-4">
                            <div class="cb-price-row">
                                <span class="cb-price-label">Original Total:</span>
                                <span class="cb-price-value original" id="original-total">£48.00</span>
                            </div>
                            <div class="cb-price-row">
    ...
    <script>
        // Original booking values (before any edits)
        const originalBooking = {
            date: '18/12/2025',
            time: '14:30 - 15:30',
            duration: '(60 minutes)',
            extras: [1, 2, 12], // Flea & Tick, Hypoallergenic, Anti-Itch
            basePrice: 4 // £48 total - £44 extras = £4 service (demo numbers)
        };

        // Currently saved values (start equal to original)
        const savedBooking = {
            date: originalBooking.date,
            time: originalBooking.time,
            duration: originalBooking.duration,
            extras: originalBooking.extras.slice(),
            extrasNames: []
        };
        ...
        // Called by extras component when selection changes
        function handleExtrasChange(ids, total, addons) {
            window._draftExtras = {
                ids: ids.slice().sort(function(a, b) { return a - b; }),
                names: addons.map(function(a) { return a.name; }),
                total: total
            };
            updatePrices();
        }
        ...
        function updatePrices() {
            ...
            const originalExtrasTotal = 14 + 20 + 10; // Flea, Hypoallergenic, Anti-Itch
            const serviceOnly = originalTotal - originalExtrasTotal;

            const root = document.getElementById('furs-addons-groomer');
            let extrasTotal = window._savedExtrasTotal;

            // If extras editor is open, use live selection
            if (!document.getElementById('extras-editor').classList.contains('is-hidden') && root && root.fursAddons) {
                extrasTotal = root.fursAddons.getTotal();
            }

            const updated = serviceOnly + (extrasTotal || 0);
            ...
            const diff = originalTotal - updated;

            if (diff > 0) {
                refundAlert.style.display = 'block';
                refundAlert.textContent = "You'll receive a £" + diff.toFixed(2) + ' refund. Refunds processed in 3-5 days';
            } else if (diff < 0) {
                refundAlert.style.display = 'block';
                refundAlert.textContent = "You'll pay an extra £" + Math.abs(diff).toFixed(2) + ' for these changes.';
            } else {
        ...
        // Close the other panel when opening one (only one editor open at a time)
        function openOnly(panel) {
            if (panel === 'datetime') {
                if (!document.getElementById('extras-editor').classList.contains('is-hidden')) {
                    const root = document.getElementById('furs-addons-groomer');
                    if (root && root.fursAddons) {
                        savedBooking.extras = root.fursAddons.getSelected().slice().sort(function(a, b) { return a - b; });
                        savedBooking.extrasNames = root.fursAddons.getAddons().map(function(a) { return a.name; });
                        window._savedExtrasTotal = root.fursAddons.getTotal();
                    }
                    showExtrasSummary();
                }
                showDatetimeEditor();
        ...
        let viewDate = new Date(2025, 11); // December 2025 to match booking card
        let selectedDateKey = '2025-12-18';

        const availableDates = [
            '2025-12-14', '2025-12-15', '2025-12-18', '2025-12-20', '2025-12-26', '2025-12-29', '2025-12-30'
        ];
        ...
        // Save date/time → show summary, close editor
        ...
        // Save extras → show summary, close editor
        ...
        // Init
        renderCalendar();
        window._savedExtrasTotal = 14 + 20 + 10;
        window._draftExtras = { ids: originalBooking.extras.slice(), names: [], total: window._savedExtrasTotal };

        // Grab initial extra names from the component after it loads
        setTimeout(function() {
            const root = document.getElementById('furs-addons-groomer');
            if (root && root.fursAddons) {
                savedBooking.extrasNames = root.fursAddons.getAddons().map(function(a) { return a.name; });

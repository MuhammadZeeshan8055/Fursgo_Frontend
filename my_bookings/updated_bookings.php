                    ...
                    <div class="col-lg-12">
                        <div class="change-booking-outer d-flex flex-column align-items-center">
                            ...
                            <div class="d-flex align-items-center gap-10 mt-5">
                                ...
                                <h1 class="large-font-bold">updated!</h1>
                            </div>
                            <p class="medium-light-font font-color">Your grooming appointment with Sarah has been updated. </p>
                            <p class="medium-light-font font-color">Please allow 24 hours for [groomer/host] to approve changes. </p>
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="what-next mt-5">
                                    ...
                                    <ul class="medium-muted-font list-style-default mt-4">
                                        <li>This booking is now cancelled.</li>
                                        <li>Any applicable refund will be processed automatically.</li>
                                    </ul>
                                </div>

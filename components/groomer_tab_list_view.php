                ...
                <div class="card mt-3">
                    <div class="left">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="270" height="246" viewBox="0 0 170 246">
                            ...
                            <image href="<?= BASE_URL ?>/assets/images/card1.png" preserveAspectRatio="xMidYMid slice"
                ...
                <div class="card mt-3">
                    <div class="left">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="270" height="246" viewBox="0 0 170 246">
                            ...
                            <!-- Image with clip path -->
                            <image href="<?= BASE_URL ?>/assets/images/card3.png" preserveAspectRatio="xMidYMid slice"
                                clip-path="url(#cardClip-list-2)" />
                        </svg>
                    </div>
                    <div class="right">
                        <div class="top-row">
                ...
                <div class="card mt-3">
                    <div class="left">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="270" height="246" viewBox="0 0 170 246">
                            ...
                            <!-- Image with clip path -->
                            <image href="<?= BASE_URL ?>/assets/images/card2.png" preserveAspectRatio="xMidYMid slice"
                                clip-path="url(#cardClip-list-3)" />
                        </svg>
                    </div>
                    <div class="right">
                        <div class="top-row">

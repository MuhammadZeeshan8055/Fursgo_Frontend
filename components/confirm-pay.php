            ...
            <div style="display: flex; gap: 24px; align-items: center;">
                ...
                <div style="font-family: Lato; line-height: 1.6;">
                    ...
                    <p id="confirmPayAddress"
                        ...
                        Full Name, 234 Elm Street, Springfield, IL 62704, United Kingdom - 07123 456789</p>
                    <p id="confirmPayMessage"
                        style="color: #9D9B98; font-family: Lato; font-size: 16px; font-weight: 400; margin: 0;">
                        Optional Message - Lorem ipsum dolor sit amet.</p>
                </div>
            </div>
            <div>
        ...
        <div class="payment-method">
            ...
            <div class="payment-icons">
                ...
                <div class="pay-icons-container">
                    ...
                    <div class="pay-btn">
                        <img src="<?= BASE_URL ?>/assets/images/icons/g-pay-icon.png" alt="G-Pay" />
                    </div>
                </div>
            </div>
            ...
            <div class="card-payment-section">
                <div class="card-payment-header">
                    <div style="display:flex;align-items:center;gap:10px;">
                        ...
                        <span style="font-family:Lato;font-size:16px;font-weight:500;color:#3B3731;">Credit/Debit
                            Card</span>
                    </div>
                </div>
...
line-height: normal;">Use my address as billing address</span>
                    ...
                    <div class="section-divide" style="background-color: #CBDCE8"></div>
...
line-height: normal;">I agree to Fursgo's <a href="#">Terms of Service</a> and <a href="#">Cancellation
            ...
            <div style="margin-top:2rem;max-width:820px;">
                ...
                <div onclick="toggleCardCheck('rememberCheck','rememberInner')"
                    ...
                    <span style="color: #3B3731; font-family: Lato; font-size: 18px; font-weight: 400;">Save my information
                ...
                <div style="border-bottom:1px solid #EBEBEB;">
                    ...
                    <div style="padding-bottom:16px;">
                        <ul style="margin:0;padding-left:20px;list-style-type:disc;">
                            <li style="color: #9D9B98; font-family: Lato; font-size: 18px; line-height: 1.5;">Groomers are
                                trained and certified professionals.</li>
                            <li style="color: #9D9B98; font-family: Lato; font-size: 18px; line-height: 1.5;">Appointments
                                are based on the service and duration you booked.</li>
                            <li style="color: #9D9B98; font-family: Lato; font-size: 18px; line-height: 1.5;">Groomers may
                                refuse service if your pet poses a safety risk.</li>
                            <li style="color: #9D9B98; font-family: Lato; font-size: 18px; line-height: 1.5;">Please ensure
                                your pet is up-to-date with vaccinations.</li>
                        </ul>
                    </div>
                </div>
                <div style="border-bottom:1px solid #EBEBEB;">
                    ...
                    <div style="display:none;padding-bottom:16px;">
                        <ul style="margin:0;padding-left:20px;list-style-type:disc;">
                            <li style="color: #9D9B98; font-family: Lato; font-size: 18px; line-height: 1.5;">All grooming
                                tools are sanitised after every pet.</li>
                            <li style="color: #9D9B98; font-family: Lato; font-size: 18px; line-height: 1.5;">Groomers
                                follow industry-standard hygiene protocols.</li>
                        </ul>
                    </div>
                </div>
                <div style="border-bottom:1px solid #EBEBEB;">
                    ...
                    <div style="display:none;padding-bottom:16px;">
                        <ul style="margin:0;padding-left:20px;list-style-type:disc;">
                            <li style="color: #9D9B98; font-family: Lato; font-size: 18px; line-height: 1.5;">Payment is
                                processed securely at time of booking.</li>
                            <li style="color: #9D9B98; font-family: Lato; font-size: 18px; line-height: 1.5;">A platform fee
                                is included in the total price shown.</li>
                        </ul>
                    </div>
                </div>
            </div>

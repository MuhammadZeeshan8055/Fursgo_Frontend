...
<head>
    ...
    <title>Fursgo - Business landing page</title>

    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="asset-base-url" content="<?= BASE_URL ?>assets/">
    ...
    <style>
        * {
        ...
        .blp-hero {
            ...
            width: 100%;
            height: 472px;
            background: url('<?= BASE_URL ?>assets/images/blp-hero-section-imagerectangle-293.png');
...
<body>
            ...
            <section class="container">
                <div class="blp-hero">
                    <div class="blp-hero-content">
                        ...
                        <a href="<?= BASE_URL ?>assets/login-groomer-space"
    ...
    <script src="<?= BASE_URL ?>assets/js/custom-dropdown.js" defer></script>

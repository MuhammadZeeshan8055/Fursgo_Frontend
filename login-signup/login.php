...
<head>
    ...
    <style>
        ...
        .login-form .login-btn:hover {
            ...
            box-shadow: 0 4px 12px rgba(251, 198, 88, 0.3);
        }
...
<body>
            ...
            <div class="col-lg-3 d-flex align-items-center justify-content-center">
                <div class="login-form mt-5">
                    ...
                    <form class="d-flex flex-column align-items-center justify-content-center mt-5">
                        ...
                        <button type="submit" class="login-btn text-center">Log in</button>
                    </form>
    ...
    <footer class="mb-5">
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-lg-12 mb-3 flex-xs-wrap d-flex align-items-center justify-content-between pt-3">

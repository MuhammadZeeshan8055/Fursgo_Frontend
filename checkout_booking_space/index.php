...
$studioImage = BASE_URL . 'assets/images/booking-space-card-image.svg';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>FursGo - Book a Space</title>
    <link rel="stylesheet" href="<?= BASE_URL ?>assets/css/responsive.css">
    <link rel="stylesheet" href="<?= BASE_URL ?>assets/css/bootstrap.css">
    <link rel="stylesheet" href="<?= BASE_URL ?>assets/css/media_query.css">
    <link rel="stylesheet" href="<?= BASE_URL ?>assets/css/common.css">
    <link rel="stylesheet" href="<?= BASE_URL ?>checkout_booking_space/checkout_booking_space.css">
</head>
...
<body class="cbg-page" data-base-url="<?= BASE_URL ?>">
                            ...
                            <div class="cbg-provider-top">
                                <div class="groomer-img-container">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="92" height="92" viewBox="0 0 92 92" fill="none">
                                        ...
                                        <image href="<?= BASE_URL ?>assets/images/booking-space-card-image.svg" preserveAspectRatio="xMidYMid slice" width="92" height="92" clip-path="url(#cardClip_721_8739)"></image>
                                    </svg>
                        ...
                        <div class="cbg-summary-studio">
                            ...
                            <div>
                                ...
                                <div class="cbg-summary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                                        <path d="M2 14V6.5L8 2.5L14 6.5V14H10V10H6V14H2Z" stroke="#FFC97A" stroke-width="1.25" stroke-linejoin="round" />
                                    </svg>
                                    Garden / Shed
                                </div>
                                <div class="cbg-summary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none" aria-hidden="true">
                                        <circle cx="7.5" cy="7.5" r="6.5" stroke="#FFC97A" />
                                        <path d="M7.5 4V7.5L10 9" stroke="#FFC97A" stroke-linecap="round" />
                                    </svg>
    ...
    <script src="<?= BASE_URL ?>checkout_booking_space/checkout_booking_space.js"></script>
</body>

                ...
                <div class="row">
                    ...
                    <div data-tab-content="space-list-view" class="tabcontent" style="display: none;">
                        ...
                        <div class="col-lg-12 d-flex flex-column align-items-center justify-content-center mt-5 mb-5">
                            ...
                            <p class="other-available-text">Please view their other available times or select a different space for this timeslot.</p>
                        </div>
                        ...
                        <section class="section-gap">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <h1 class="section-title">Your selected space’s availability</h1>
                                    </div>
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="col-lg-12 d-flex justify-content-end mt-3">
                                            <a href="<?= BASE_URL ?>profiles/space/space_profile.php" class="view-more">View more</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card space-cards flex-column active">
                                        <div class="left">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 255 130"
                                                fill="none">
                                                <defs>
                                                    <pattern id="pattern-card-1-1" patternUnits="userSpaceOnUse"
                                    ...
                                    <div class="card space-cards flex-column active">
                                        <div class="left">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 255 130"
                                                fill="none">
                                                <defs>
                                                    <pattern id="pattern-card-2-1" patternUnits="userSpaceOnUse"
                                                        width="255" height="130">
                                    ...
                                    <div class="card space-cards flex-column active">
                                        <div class="left">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 255 130"
                                                fill="none">
                                                <defs>
                                                    <pattern id="pattern-card-3-1" patternUnits="userSpaceOnUse"
                                                        width="255" height="130">
                                    ...
                                    <div class="card space-cards flex-column active">
                                        <div class="left">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 255 130"
                                                fill="none">
                                                <defs>
                                                    <pattern id="pattern-card-4-1" patternUnits="userSpaceOnUse"
                                                        width="255" height="130">
                                                        <image href="<?= BASE_URL ?>/assets/images/space_card1.png" width="255"
                                                            height="130" preserveAspectRatio="xMidYMid slice" />
                                                    </pattern>

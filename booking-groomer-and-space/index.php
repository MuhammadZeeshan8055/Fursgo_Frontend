...
<head>
    ...
    <style>
        ...
        .service-summary>div:nth-child(2)>div>.service-summary-img {
            width: 90.812px;
            height: 90.812px;
            aspect-ratio: 1/1;
            border-radius: 50%;
        ...
        .service-summary>div:nth-child(4)>span>img {
            width: 1rem !important;
            height: auto;
        }

        .service-summary .add-ons-summary-title {
            color: #3B3731;
            font-family: Lato;
            font-size: 14px;
            font-style: normal;
        ...
        .service-summary-addons-list {
            margin-top: 1.5rem;
        }

        .service-summary-addons-list>div {
            display: flex;
            justify-content: space-between;
            align-items: center;
        }

        .service-summary-addons-list>div>p {
            color: #3B3731;
            font-family: Lato;
            font-size: 14px;
            font-style: normal;
...
(e.g. anxious around dryers, allergies, behaviour cues)" rows="4" cols="50" id="petNotes"></textarea>
                    ...
                    <div class="add-ons-actions" style="margin-top: 2.5rem; display: flex; justify-content: flex-end;">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function updateSummaryTotal() {
                ...
                let finalTotal = spaceTotal - promoDiscount;
  ...
  <path d="M7.48951 6.21899L10.9422 7.144M6.93408 8.2906L9.00569 8.84532" stroke="#9D9B98" stroke-linecap="round"/>
    ...
    `;
                ...
                document.getElementById('petConfirmBtn').addEventListener('click', function (e) {
                    ...
                    if (chosen.length > 0) {
                        const selectedPet = chosen[0];

                        // Map list fields to display details fields
                        const petDetails = {

                ...
                <div class="row">
                    ...
                    <div data-tab-content="groomer-calendar-view" class="tabcontent">
                        ...
                        <div class="col-lg-12 d-flex align-items-center justify-content-center section-gap">
                            <p class="not-found-message">Sorry, <span class="not-found-message">your preferred time isn't available today, <br>
                                    please see below for next availabilities!</span></p>
                        </div>

            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <p class="other-available-text">Please view their other available times or select a
                            different space for this timeslot.</p>
                    </div>
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <defs>
                                                        <pattern id="pattern0" patternUnits="userSpaceOnUse" width="138"
                                                            height="138">
                                                            <image xlink:href="../assets/images/card1.png" width="138"
